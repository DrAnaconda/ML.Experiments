...
namespace ML_ExperimentsML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\downloads\Windir\titanic\train.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Survived", "Survived")
                                      ...
                                      .Append(mlContext.Transforms.Categorical.OneHotHashEncoding(new[] { new InputOutputColumnPair("Pclass", "Pclass"), new InputOutputColumnPair("SibSp", "SibSp"), new InputOutputColumnPair("Parch", "Parch") }))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Sex", "Pclass", "SibSp", "Parch", "Age", "Fare" }))
